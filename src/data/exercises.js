...
import { SPA_EXERCISES } from './spa';
import { MONZA_EXERCISES } from './monza';
import { SILVERSTONE_EXERCISES } from './silverstone';
...
export const ALL_EXERCISES = [...BRAKE_EXERCISES, ...THROTTLE_EXERCISES, ...CLUTCH_EXERCISES, ...STEERING_EXERCISES, ...COMBINED_EXERCISES, ...INTERLAGOS_EXERCISES, ...SPA_EXERCISES, ...MONZA_EXERCISES, ...SILVERSTONE_EXERCISES, ...ALL_GEAR_EXERCISES];
